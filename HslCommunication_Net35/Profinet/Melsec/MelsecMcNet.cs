...
namespace HslCommunication.Profinet.Melsec
{
    ...
    /// </summary>
    public class MelsecMcNet : NetworkDoubleBase<MelsecQnA3EMessage,RegularByteTransform>,IReadWriteNet
    {
                    ...
                    case 'm':
                        {
                            ...
                            result.Content2 = Convert.ToUInt16( address.Substring( 1 ), 10 );
                            break;
                        }
                    case 'X':
                    case 'x':
                        {
                            ...
                            result.Content2 = Convert.ToUInt16( address.Substring( 1 ), 16 );
                            break;
                        }
                    case 'Y':
                    case 'y':
