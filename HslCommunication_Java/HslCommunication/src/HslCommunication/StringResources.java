...
public class StringResources {
    ...
    public static final String  FilePathCreateFailed = "文件夹路径创建失败";
    ...
    public static final String  ModbusTcpFunctionCodeNotSupport = "不支持的功能码";
    public static final String  ModbusTcpFunctionCodeOverBound = "读取的数据越界";
    public static final String  ModbusTcpFunctionCodeQuantityOver = "读取长度超过最大值";
    public static final String  ModbusTcpFunctionCodeReadWriteException = "读写异常";
    public static final String  ModbusTcpReadCoilException = "读取线圈异常";
    public static final String  ModbusTcpWriteCoilException = "写入线圈异常";
    public static final String  ModbusTcpReadRegisterException = "读取寄存器异常";
    public static final String  ModbusTcpWriteRegisterException = "写入寄存器异常";
